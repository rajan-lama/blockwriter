...
if (typeof document !== "undefined" && process.env.NODE_ENV !== "test" && !document.head.querySelector("style[data-wp-hash='fb2485c572']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "fb2485c572");
  ...
  const element = (0, import_react.useRender)({
    ...
    props: (0, import_react.mergeProps)(props, {
      className: (0, import_clsx.default)(
        ...
        openInNewTab && style_default["has-link-icon"],
        className
      ),
      onClick: handleClick,
      target: openInNewTab ? "_blank" : void 0,
      children: openInNewTab ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: style_default["link-contents"], children }),
