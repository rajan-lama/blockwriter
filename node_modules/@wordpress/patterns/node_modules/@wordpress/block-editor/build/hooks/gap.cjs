...
var import_utils = require("../components/spacing-sizes-control/utils.cjs");
...
function getGapCSSValue(blockGapValue, defaultValue = "0") {
  ...
  const row = (0, import_utils.getSpacingPresetCssVar)(blockGapBoxControlValue?.top) || defaultValue;
  const column = (0, import_utils.getSpacingPresetCssVar)(blockGapBoxControlValue?.left) || defaultValue;
