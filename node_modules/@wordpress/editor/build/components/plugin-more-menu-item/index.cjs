...
var plugin_more_menu_item_exports = {};
__export(plugin_more_menu_item_exports, {
  default: () => PluginMoreMenuItem
});
module.exports = __toCommonJS(plugin_more_menu_item_exports);
