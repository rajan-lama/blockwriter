...
var block_edit_visually_button_exports = {};
__export(block_edit_visually_button_exports, {
  default: () => BlockEditVisuallyButton
});
module.exports = __toCommonJS(block_edit_visually_button_exports);
...
function BlockEditVisuallyButton({ clientIds }) {
  ...
  const canEditVisually = (0, import_data.useSelect)(
    (select) => !!clientId && select(import_store.store).getBlockMode(clientId) === "html",
    [clientId]
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.ToolbarGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_components.ToolbarButton,
    {
      ...
      children: (0, import_i18n.__)("Edit visually")
    }
  ) });
}
