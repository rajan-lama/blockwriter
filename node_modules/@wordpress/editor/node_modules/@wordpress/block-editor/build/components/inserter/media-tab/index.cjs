...
__export(media_tab_exports, {
  MediaCategoryPanel: () => import_media_panel.MediaCategoryPanel,
  MediaTab: () => import_media_tab.default,
  useMediaCategories: () => import_hooks.useMediaCategories
});
module.exports = __toCommonJS(media_tab_exports);
var import_media_tab = __toESM(require("./media-tab.cjs"));
