...
import DocumentOutlineItem from "./item.mjs";
...
function EmptyOutlineIllustration() {
  return /* @__PURE__ */ jsxs(
    SVG,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Rect, { width: "138", height: "148", rx: "4", fill: "#F0F6FC" }),
        /* @__PURE__ */ jsx(Line, { x1: "44", y1: "28", x2: "24", y2: "28", stroke: "#DDDDDD" }),
        /* @__PURE__ */ jsx(Rect, { x: "48", y: "16", width: "27", height: "23", rx: "4", fill: "#DDDDDD" }),
        /* @__PURE__ */ jsx(
          Path,
          {
        ...
        /* @__PURE__ */ jsx(Line, { x1: "55", y1: "59", x2: "24", y2: "59", stroke: "#DDDDDD" }),
        /* @__PURE__ */ jsx(Rect, { x: "59", y: "47", width: "29", height: "23", rx: "4", fill: "#DDDDDD" }),
        /* @__PURE__ */ jsx(
          Path,
          {
        ...
        /* @__PURE__ */ jsx(Line, { x1: "80", y1: "90", x2: "24", y2: "90", stroke: "#DDDDDD" }),
        /* @__PURE__ */ jsx(Rect, { x: "84", y: "78", width: "30", height: "23", rx: "4", fill: "#F0B849" }),
        /* @__PURE__ */ jsx(
          Path,
          {
        ...
        /* @__PURE__ */ jsx(Line, { x1: "66", y1: "121", x2: "24", y2: "121", stroke: "#DDDDDD" }),
        /* @__PURE__ */ jsx(Rect, { x: "70", y: "109", width: "29", height: "23", rx: "4", fill: "#DDDDDD" }),
        /* @__PURE__ */ jsx(
          Path,
          {
...
function DocumentOutline({
  ...
  const contentBlocks = useSelect((select) => {
    ...
    const { getBlocksByName, getClientIdsOfDescendants } = select(blockEditorStore);
  ...
  if (headings.length < 1) {
    return /* @__PURE__ */ jsxs("div", { className: "editor-document-outline has-no-headings", children: [
      /* @__PURE__ */ jsx(EmptyOutlineIllustration, {}),
  ...
  return /* @__PURE__ */ jsx("div", { className: "document-outline", children: /* @__PURE__ */ jsxs("ul", { children: [
    ...
    headings.map((item) => {
      ...
      return /* @__PURE__ */ jsxs(
        DocumentOutlineItem,
        {
          ...
          children: [
            item.isEmpty ? emptyHeadingContent : getTextContent(
              create({
