...
var block_icon_exports = {};
__export(block_icon_exports, {
  default: () => block_icon_default
});
module.exports = __toCommonJS(block_icon_exports);
...
function BlockIcon({ icon, showColors = false, className, context }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    {
      style,
      className: (0, import_clsx.default)("block-editor-block-icon", className, {
...
var block_icon_default = (0, import_element.memo)(BlockIcon);
