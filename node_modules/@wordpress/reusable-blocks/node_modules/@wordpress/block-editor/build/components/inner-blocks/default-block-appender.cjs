...
function DefaultBlockAppender() {
  const { clientId } = (0, import_context.useBlockEditContext)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_default_block_appender.default, { rootClientId: clientId });
}
//# sourceMappingURL=default-block-appender.cjs.map
