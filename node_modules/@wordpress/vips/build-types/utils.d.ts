 ...
 */
export declare function supportsQuality(type: string): type is 'image/jpeg' | 'image/png' | 'image/webp' | 'image/avif';
/**
 ...
 */
export declare function supportsAnimation(type: string): type is 'image/webp' | 'image/gif';
/**
 ...
 */
export declare function supportsInterlace(type: string): type is 'image/jpeg' | 'image/gif' | 'image/png';
