...
function useBlockControlsFill(group, shareWithChildBlocks) {
  ...
  if (context[import_context.mayDisplayControlsKey]) {
    return import_groups.default[group]?.Fill;
  }
  if (context[import_context.mayDisplayParentControlsKey] && shareWithChildBlocks) {
    return import_groups.default.parent.Fill;
  }
  return null;
}
