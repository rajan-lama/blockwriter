...
var input_events_exports = {};
__export(input_events_exports, {
  default: () => input_events_default
});
module.exports = __toCommonJS(input_events_exports);
...
//# sourceMappingURL=input-events.cjs.map
