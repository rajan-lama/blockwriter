...
export interface FontLibraryState {
    ...
    isFontActivated: (slug: string, style?: string, weight?: string | number, source?: string) => boolean;
    getFontFacesActivated: (slug: string, source?: string) => string[];
    toggleActivateFont: (font: FontFamily, face?: FontFace) => void;
    getAvailableFontsOutline: (availableFontFamilies: FontFamily[]) => Record<string, string[]>;
    saveFontFamilies: (fonts: FontFamilyPreset[] | Record<string, FontFamilyPreset[]> | undefined) => Promise<void>;
