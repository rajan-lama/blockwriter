...
var panel_color_settings_exports = {};
__export(panel_color_settings_exports, {
  default: () => panel_color_settings_default
});
module.exports = __toCommonJS(panel_color_settings_exports);
...
var PanelColorSettings = ({ colorSettings, ...props }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_panel_color_gradient_settings.default,
    {
      settings,
      gradients: [],
