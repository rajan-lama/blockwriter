...
var import_with_color_context = __toESM(require("./with-color-context.cjs"));
var color_palette_default = (0, import_with_color_context.default)(import_components.ColorPalette);
