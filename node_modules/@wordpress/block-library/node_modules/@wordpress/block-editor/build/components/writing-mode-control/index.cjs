...
var writing_mode_control_exports = {};
__export(writing_mode_control_exports, {
  default: () => WritingModeControl
});
module.exports = __toCommonJS(writing_mode_control_exports);
...
var WRITING_MODES = [
  {
    ...
    value: "horizontal-tb",
    icon: import_icons.textHorizontal
  },
  {
    label: (0, import_i18n.__)("Vertical"),
    value: (0, import_i18n.isRTL)() ? "vertical-lr" : "vertical-rl",
    icon: import_icons.textVertical
  }
];
function WritingModeControl({ className, value, onChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_components.__experimentalToggleGroupControl,
    {
      ...
      className: (0, import_clsx.default)("block-editor-writing-mode-control", className),
      value,
      onChange: (newValue) => {
