...
import InnerBlocks from "../inner-blocks/index.mjs";
...
function getRichTextValues(blocks = []) {
  ...
  return values.map(
    (value) => value instanceof RichTextData ? value : RichTextData.fromHTMLString(value)
  );
}
export {
  getRichTextValues
};
//# sourceMappingURL=get-rich-text-values.mjs.map
