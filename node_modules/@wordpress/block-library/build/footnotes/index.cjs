...
var init = () => {
  (0, import_rich_text.registerFormatType)(import_format.formatName, import_format.format);
  (0, import_init_block.default)({ name, metadata: import_block.default, settings });
};
