...
var parent_control_exports = {};
__export(parent_control_exports, {
  default: () => parent_control_default
});
module.exports = __toCommonJS(parent_control_exports);
...
function ParentControl({ parents, postType, onChange }) {
  ...
  const currentParents = (0, import_data.useSelect)(
    (select) => {
      if (!parents?.length) {
        return EMPTY_ARRAY;
      }
  ...
  (0, import_element.useEffect)(() => {
    ...
    const currentParentsInfo = (0, import_utils.getEntitiesInfo)(
      (0, import_utils.mapToIHasNameAndId)(currentParents, "title.rendered")
    );
  ...
  const entitiesInfo = (0, import_element.useMemo)(() => {
    ...
    return (0, import_utils.getEntitiesInfo)(
      (0, import_utils.mapToIHasNameAndId)(searchResults, "title.rendered")
    );
  }, [searchResults]);
  (0, import_element.useEffect)(() => {
...
//# sourceMappingURL=parent-control.cjs.map
