...
function save({ attributes }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { ...import_block_editor.useBlockProps.save(), children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_block_editor.RichText.Content,
    {
      tagName: "code",
      value: (0, import_utils.escape)(
