...
function ColumnInspectorControls({
  ...
  const { count, canInsertColumnBlock, minCount } = useSelect(
    (select) => {
      const { canInsertBlockType, canRemoveBlock, getBlockOrder } = select(blockEditorStore);
  ...
  return /* @__PURE__ */ jsxs(
    ToolsPanel,
    {
      ...
      dropdownMenuProps,
      children: [
        canInsertColumnBlock && /* @__PURE__ */ jsxs(VStack, { spacing: 4, style: { gridColumn: "1 / -1" }, children: [
          /* @__PURE__ */ jsx(
            RangeControl,
            {
          ...
          count > 6 && /* @__PURE__ */ jsx(Notice, { status: "warning", isDismissible: false, children: __(
