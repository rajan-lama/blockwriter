...
var registeredStore = (0, import_data.registerStore)(import_constants.STORE_NAME, {
  ...storeConfig,
  persist: ["preferences"]
});
(0, import_lock_unlock.unlock)(registeredStore).registerPrivateActions(privateActions);
(0, import_lock_unlock.unlock)(registeredStore).registerPrivateSelectors(privateSelectors);
