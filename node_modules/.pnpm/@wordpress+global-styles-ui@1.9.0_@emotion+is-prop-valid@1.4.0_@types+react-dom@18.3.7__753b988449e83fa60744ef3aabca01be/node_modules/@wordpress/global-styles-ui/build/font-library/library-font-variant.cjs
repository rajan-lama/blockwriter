...
var library_font_variant_exports = {};
__export(library_font_variant_exports, {
  default: () => library_font_variant_default
});
module.exports = __toCommonJS(library_font_variant_exports);
...
function LibraryFontVariant({
  ...
  const { isFontActivated, toggleActivateFont } = (0, import_element.useContext)(import_context.FontLibraryContext);
...
//# sourceMappingURL=library-font-variant.cjs.map
