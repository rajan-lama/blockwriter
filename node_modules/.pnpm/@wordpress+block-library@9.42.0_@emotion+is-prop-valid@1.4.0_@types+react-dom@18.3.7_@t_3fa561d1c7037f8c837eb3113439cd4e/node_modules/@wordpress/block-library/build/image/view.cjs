...
var { state, actions, callbacks } = (0, import_interactivity.store)(
  "core/image",
  {
    state: {
      ...
      get ariaLabel() {
        return state.selectedImage.customAriaLabel || (0, import_interactivity.getConfig)().defaultAriaLabel;
      },
      get closeButtonAriaLabel() {
        return state.hasNavigationText ? void 0 : (0, import_interactivity.getConfig)().closeButtonText;
      },
      get prevButtonAriaLabel() {
        return state.hasNavigationText ? void 0 : (0, import_interactivity.getConfig)().prevButtonText;
      },
      get nextButtonAriaLabel() {
        return state.hasNavigationText ? void 0 : (0, import_interactivity.getConfig)().nextButtonText;
      },
      get enlargedSrc() {
    ...
    actions: {
      showLightbox() {
        ...
        const { galleryId } = (0, import_interactivity.getContext)("core/gallery") || {};
      ...
      showPreviousImage: (0, import_interactivity.withSyncEvent)((event) => {
      ...
      showNextImage: (0, import_interactivity.withSyncEvent)((event) => {
        event.stopPropagation();
      ...
      handleTouchMove: (0, import_interactivity.withSyncEvent)((event) => {
        if (state.overlayEnabled) {
          event.preventDefault();
        }
      }),
      ...
      handleTouchEnd: (0, import_interactivity.withSyncEvent)((event) => {
      ...
      preloadImageWithDelay() {
        ...
        const timerId = setTimeout(
          (0, import_interactivity.withScope)(() => {
            actions.preloadImage();
            state.preloadTimers.delete(imageId);
          }),
          import_constants.IMAGE_PRELOAD_DELAY
        );
