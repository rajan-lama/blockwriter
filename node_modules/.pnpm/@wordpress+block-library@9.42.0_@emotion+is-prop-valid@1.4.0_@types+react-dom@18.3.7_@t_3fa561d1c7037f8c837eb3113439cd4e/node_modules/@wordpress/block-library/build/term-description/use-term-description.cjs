...
var use_term_description_exports = {};
__export(use_term_description_exports, {
  useTermDescription: () => useTermDescription
});
module.exports = __toCommonJS(use_term_description_exports);
var import_core_data = require("@wordpress/core-data");
var import_data = require("@wordpress/data");
function useTermDescription(termId, taxonomy) {
  const [description, setDescription, fullDescription] = (0, import_core_data.useEntityProp)(
    "taxonomy",
    taxonomy,
    "description",
    termId
...
//# sourceMappingURL=use-term-description.cjs.map
