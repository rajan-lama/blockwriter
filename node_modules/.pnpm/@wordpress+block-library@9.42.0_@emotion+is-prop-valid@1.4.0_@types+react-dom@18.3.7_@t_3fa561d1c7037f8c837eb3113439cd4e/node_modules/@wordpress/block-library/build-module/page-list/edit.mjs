...
import { useConvertToNavigationLinks } from "./use-convert-to-navigation-links.mjs";
import {
  convertDescription,
  ConvertToLinksModal
} from "./convert-to-links-modal.mjs";
...
function BlockContent({
  ...
  if (!hasResolvedPages) {
    return /* @__PURE__ */ jsx("div", { ...blockProps, children: /* @__PURE__ */ jsx("div", { className: "wp-block-page-list__loading-indicator-container", children: /* @__PURE__ */ jsx(Spinner, { className: "wp-block-page-list__loading-indicator" }) }) });
  }
  if (pages === null) {
    return /* @__PURE__ */ jsx("div", { ...blockProps, children: /* @__PURE__ */ jsx(Notice, { status: "warning", isDismissible: false, children: __("Page List: Cannot retrieve Pages.") }) });
  }
  if (pages.length === 0) {
    return /* @__PURE__ */ jsx("div", { ...blockProps, children: /* @__PURE__ */ jsx(Notice, { status: "info", isDismissible: false, children: __("Page List: Cannot retrieve Pages.") }) });
  }
  if (blockList.length === 0) {
    ...
    if (parentPageDetails?.title?.rendered) {
      return /* @__PURE__ */ jsx("div", { ...blockProps, children: /* @__PURE__ */ jsx(Warning, { children: sprintf(
...
function PageListEdit({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    (pagesTree.length > 0 || allowConvertToLinks) && /* @__PURE__ */ jsx(InspectorControls, { children: /* @__PURE__ */ jsxs(
      ToolsPanel,
      {
        label: __("Settings"),
        resetAll: () => {
        ...
        dropdownMenuProps,
        children: [
          pagesTree.length > 0 && /* @__PURE__ */ jsx(
            ToolsPanelItem,
            {
          ...
          allowConvertToLinks && /* @__PURE__ */ jsxs("div", { style: { gridColumn: "1 / -1" }, children: [
            /* @__PURE__ */ jsx("p", { children: convertDescription }),
            /* @__PURE__ */ jsx(
              Button,
              {
                __next40pxDefaultSize: true,
    ...
    allowConvertToLinks && /* @__PURE__ */ jsxs(Fragment, { children: [
