...
function recreateWithRecommendedBlocks(attributes, blockTypes) {
  ...
  return createBlock(
    ...
    [
      shouldInsertAvatarBlock && createBlock("core/avatar", {
        size: avatarSize,
        style: cleanEmptyObject({
          border: {
            radius: "0px"
      ...
      createBlock(
        ...
        [
          shouldInsertParagraphBlock && createBlock("core/paragraph", {
            content: byline,
          ...
          shouldInsertPostAuthorNameBlock && createBlock("core/post-author-name", {
            isLink,
            linkTarget,
            style: {
              typography: {
          ...
          shouldInsertPostAuthorBiographyBlock && createBlock("core/post-author-biography", {
            style: {
              typography: {
                fontSize: "0.7em",
                textAlign
