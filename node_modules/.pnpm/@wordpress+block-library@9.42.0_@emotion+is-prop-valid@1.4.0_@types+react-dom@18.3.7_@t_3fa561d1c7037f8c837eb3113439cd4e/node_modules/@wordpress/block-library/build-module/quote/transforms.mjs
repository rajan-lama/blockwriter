...
var transforms = {
  ...
  to: [
    ...
    },
    {
      type: "block",
      blocks: ["core/group"],
      transform: ({ citation, anchor }, innerBlocks) => createBlock(
        "core/group",
        { anchor },
        RichText.isEmpty(citation) ? innerBlocks : [
          ...innerBlocks,
          createBlock("core/paragraph", {
            content: citation
          })
  ...
  ungroup: ({ citation }, innerBlocks) => RichText.isEmpty(citation) ? innerBlocks : [
    ...innerBlocks,
    createBlock("core/paragraph", {
      content: citation
    })
