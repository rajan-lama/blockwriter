...
import type { FontCollection, CollectionFontFamily, CollectionFontFace } from './font-collection';
...
export type { Attachment, Base as UnstableBase, CollectionFontFace, CollectionFontFamily, Comment, Context, FontCollection, FontFace, FontFamily, GlobalStylesRevision, Icon, MenuLocation, NavMenu, NavMenuItem, Page, Plugin, Post, PostRevision, PostStatusObject, Settings, Sidebar, Taxonomy, TemplatePartArea, TemplateType, Term, Theme, Type, Updatable, User, Widget, WidgetType, WpFontFamily, WpTemplate, WpTemplatePart, };
/**
 ...
 */
export interface PerPackageEntityRecords<C extends Context> {
    core: Base<C> | Attachment<C> | Comment<C> | FontCollection<C> | GlobalStylesRevision<C> | Icon<C> | MenuLocation<C> | NavMenu<C> | NavMenuItem<C> | Page<C> | Plugin<C> | Post<C> | PostStatusObject<C> | PostRevision<C> | Settings<C> | Sidebar<C> | Taxonomy<C> | Term<C> | Theme<C> | User<C> | Type<C> | Widget<C> | WidgetType<C> | WpFontFamily<C> | WpTemplate<C> | WpTemplatePart<C>;
}
/**
