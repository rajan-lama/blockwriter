...
declare module './base-entity-records' {
    namespace BaseEntityRecords {
        interface FontCollection<C extends Context> {
            /**
...
export type FontCollection<C extends Context = 'edit'> = _BaseEntityRecords.FontCollection<C>;
export type { _BaseEntityRecords as BaseEntityRecords };
//# sourceMappingURL=font-collection.d.ts.map