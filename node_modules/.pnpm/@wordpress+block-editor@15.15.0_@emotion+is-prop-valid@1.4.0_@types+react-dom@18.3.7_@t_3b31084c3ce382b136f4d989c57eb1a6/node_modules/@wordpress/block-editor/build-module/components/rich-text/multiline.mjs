...
import { RichTextWrapper } from "./index.mjs";
...
function RichTextMultiline({
  ...
  return /* @__PURE__ */ jsx(TagName, { ref: forwardedRef, children: values.map((_value, index) => {
    return /* @__PURE__ */ jsx(
      RichTextWrapper,
      {
        ...
        onKeyDown: (event) => {
          ...
          const array = split(richTextValue).map(
            (v) => toHTMLString({ value: v })
          );
          const newValues = values.slice();
...
var multiline_default = forwardRef(RichTextMultiline);
export {
  multiline_default as default
};
//# sourceMappingURL=multiline.mjs.map
