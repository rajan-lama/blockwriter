...
var getEditorCommandLoader = () => function useEditorCommandLoader() {
  ...
  commands.push({
    ...
    callback: ({ close }) => {
      ...
      close();
      createInfoNotice(
        showBlockBreadcrumbs ? __("Breadcrumbs hidden.") : __("Breadcrumbs visible."),
        {
  ...
  commands.push({
    ...
    callback: ({ close }) => {
      ...
      createInfoNotice(
        isPublishSidebarEnabled ? __("Pre-publish checks disabled.") : __("Pre-publish checks enabled."),
        {
...
var getPageContentFocusCommands = () => function usePageContentFocusCommands() {
  const {
    ...
    return {
      ...
      canEditTemplate: !!_templateId && select(coreStore).canUser("update", {
        kind: "postType",
        name: "wp_template",
        id: _templateId
      })
