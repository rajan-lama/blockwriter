...
var plugin_preview_menu_item_exports = {};
__export(plugin_preview_menu_item_exports, {
  default: () => PluginPreviewMenuItem
});
module.exports = __toCommonJS(plugin_preview_menu_item_exports);
...
function PluginPreviewMenuItem(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_interface.ActionItem,
    {
      name: "core/plugin-preview-menu",
      as: props.as ?? import_components.MenuItem,
