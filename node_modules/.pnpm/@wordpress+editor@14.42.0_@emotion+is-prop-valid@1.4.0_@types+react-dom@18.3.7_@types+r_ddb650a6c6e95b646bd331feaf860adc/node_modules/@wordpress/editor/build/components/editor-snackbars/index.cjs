...
function EditorSnackbars() {
  (0, import_deprecated.default)("wp.editor.EditorSnackbars", {
    since: "7.0",
    version: "7.2",
    alternative: "wp.notices.SnackbarNotices"
  });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_notices.SnackbarNotices, { className: "components-editor-notices__snackbar" });
}
