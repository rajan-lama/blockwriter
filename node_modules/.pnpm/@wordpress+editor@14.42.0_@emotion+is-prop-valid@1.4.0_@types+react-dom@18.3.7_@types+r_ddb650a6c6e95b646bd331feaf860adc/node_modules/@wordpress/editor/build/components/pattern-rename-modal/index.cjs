...
var pattern_rename_modal_exports = {};
__export(pattern_rename_modal_exports, {
  default: () => PatternRenameModal,
  modalName: () => modalName
});
module.exports = __toCommonJS(pattern_rename_modal_exports);
...
function PatternRenameModal() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RenamePatternModal, { onClose: closeModal, pattern: record });
}
