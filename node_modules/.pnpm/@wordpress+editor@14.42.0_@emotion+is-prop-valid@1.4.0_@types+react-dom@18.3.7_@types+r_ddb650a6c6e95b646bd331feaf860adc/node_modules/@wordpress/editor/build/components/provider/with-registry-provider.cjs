...
function getSubRegistry(subRegistries, registry, useSubRegistry) {
  ...
  if (!subRegistry) {
    subRegistry = (0, import_data.createRegistry)(
      {
        "core/block-editor": import_block_editor.storeConfig
      },
      registry
    );
    subRegistry.registerStore("core/editor", import_store.storeConfig);
