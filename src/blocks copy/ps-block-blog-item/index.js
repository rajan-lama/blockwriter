		...
		return [
			...
			<BlockControls key="controls">
				<AlignmentToolbar
					...
					onChange={(value) =>
						setAttributes({ blogItemAlignment: value })
					}
				/>
			</BlockControls>,
			...
			<BlogItem {...this.props}>
				<RichText
					...
					className={classnames('ps-blogItem-text')}
					style={{
						textAlign: blogItemAlignment,
					}}
					onChange={(value) =>
						setAttributes({ blogItemContent: value })
					}
				/>
				...
				<div class="ps-blogItem-info">
					...
					<RichText
						...
						onChange={(value) =>
							this.props.setAttributes({ blogItemName: value })
						}
					/>
					...
					<RichText
						...
						onChange={(value) =>
							this.props.setAttributes({ blogItemTitle: value })
						}
					/>
				</div>
			</BlogItem>,
...
registerBlockType('prosys-blocks/ps-blogItem', {
	...
	description: __(
		'Add a user blogItem with a name and title.',
		'prosys-blocks'
	),
	icon: 'format-quote',
