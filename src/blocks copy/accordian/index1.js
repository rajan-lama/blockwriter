...
const accordionAttrs = metadata.attributes;
			...
			return (
				<Fragment>
					...
					<div className="ppb-accordion-block">
						<div
							className="ppb-accordion-header"
							style={{
