...
export default function Edit({ attributes, setAttributes }) {
          ...
          <div className="carousel-inner">
            {slides.map((slide, index) => (
              ...
              >
                ...
                {slide.btn1Text && <a href={slide.btn1Url}>{slide.btn1Text}</a>}

                {slide.btn2Text && <a href={slide.btn2Url}>{slide.btn2Text}</a>}
              </div>
            ))}
          </div>
        </div>
  ...
  return (
    <div {...blockProps}>
      ...
      <Button icon={eye} onClick={togglePreview} style={{ marginLeft: '10px' }}>
        Preview
      </Button>
            ...
            <tr key={index}>
              ...
              <td>
                <TextControl
                  ...
                  onChange={(val) => updateField(index, 'subtitle', val)}
                />
              </td>
              ...
              <td>
                <TextControl
                  ...
                  onChange={(val) => updateField(index, 'btn1Text', val)}
                />
              </td>
              ...
              <td>
                <TextControl
                  value={slide.btn1Url}
                  onChange={(val) => updateField(index, 'btn1Url', val)}
                />
              </td>
              ...
              <td>
                <TextControl
                  ...
                  onChange={(val) => updateField(index, 'btn2Text', val)}
                />
              </td>
              ...
              <td>
                <TextControl
                  value={slide.btn2Url}
                  onChange={(val) => updateField(index, 'btn2Url', val)}
                />
              </td>
