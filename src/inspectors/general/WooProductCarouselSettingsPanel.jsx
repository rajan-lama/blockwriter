...
const WooProductCarouselSettingsPanel = ( { attributes, setAttributes } ) => {
	const {
		perPage,
		columns,
		orderBy,
			...
			>
				...
				{ categories.length > 0 && (
					<>
						...
						<div
							className="bw-woo-product-carousel-categories"
							style={ {
								maxHeight: 180,
								overflowY: 'auto',
								marginBottom: 12,
...
export default WooProductCarouselSettingsPanel;
